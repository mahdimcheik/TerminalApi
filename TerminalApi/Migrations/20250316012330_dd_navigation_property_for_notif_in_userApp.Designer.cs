...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250316012330_dd_navigation_property_for_notif_in_userApp")]
    partial class dd_navigation_property_for_notif_in_userApp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("82c7bf30-292b-46ac-8e26-40208dce7da7"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 3, 16, 1, 23, 29, 616, DateTimeKind.Utc).AddTicks(5137)
                        });
                });
