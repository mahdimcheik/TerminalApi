...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250330194241_fix_notificationDatetime_formatv1")]
    partial class fix_notificationDatetime_formatv1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3ac0b7b8-292e-4497-8c39-dd7aea95458d"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 3, 30, 19, 42, 40, 913, DateTimeKind.Utc).AddTicks(6686)
                        });
                });
