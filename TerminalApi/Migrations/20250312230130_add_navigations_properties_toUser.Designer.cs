...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250312230130_add_navigations_properties_toUser")]
    partial class add_navigations_properties_toUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.Notification.Notification", b =>
                {
                    ...
                    b.HasOne("TerminalApi.Models.User.UserApp", "Student")
                        .WithMany()
