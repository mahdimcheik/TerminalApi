...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250814204853_communications_jsonb")]
    partial class communications_jsonb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.Booking", b =>
                {
                    ...
                    b.Property<ICollection<ChatMessage>>("Communications")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("TerminalApi.Models.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3172c0cf-8ca9-4cc2-b2b3-a7cabf017df7"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 8, 14, 20, 48, 52, 834, DateTimeKind.Utc).AddTicks(4894)
                        });
                });
