...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250312233337_modifying__notification_sender_reciever_createAt")]
    partial class modifying__notification_sender_reciever_createAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c96bdfe-2181-4cd8-8510-d1f81e9bca1b"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 3, 12, 23, 33, 36, 815, DateTimeKind.Utc).AddTicks(8915)
                        });
                });
