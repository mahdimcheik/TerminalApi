...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250309165109_Add_TVA_to_order")]
    partial class Add_TVA_to_order
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2ba62d15-3f43-4164-9748-665a8d76a176"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 3, 9, 16, 51, 8, 964, DateTimeKind.Utc).AddTicks(7146)
                        });
                });
