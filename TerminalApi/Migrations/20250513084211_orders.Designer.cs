...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250513084211_orders")]
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("66cf7f58-cf6d-4dcc-a8ca-aebb28fc21c6"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 5, 13, 8, 42, 10, 856, DateTimeKind.Utc).AddTicks(7743)
                        });
                });
