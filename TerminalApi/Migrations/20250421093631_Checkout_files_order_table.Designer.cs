...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250421093631_Checkout_files_order_table")]
    partial class Checkout_files_order_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("71f15758-4b4a-42d5-812d-d363fc3b1d1e"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 4, 21, 9, 36, 31, 191, DateTimeKind.Utc).AddTicks(8991)
                        });
                });
