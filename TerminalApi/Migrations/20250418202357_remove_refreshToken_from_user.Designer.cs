...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250418202357_remove_refreshToken_from_user")]
    partial class remove_refreshToken_from_user
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bfdb1dc5-c57d-4cbb-b0e9-9fcaebb8ef92"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 4, 18, 20, 23, 57, 136, DateTimeKind.Utc).AddTicks(4171)
                        });
                });
