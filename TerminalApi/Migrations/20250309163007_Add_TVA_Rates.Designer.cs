...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250309163007_Add_TVA_Rates")]
    partial class Add_TVA_Rates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1c4073b-27a5-4d8c-ae22-e129730db663"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 3, 9, 16, 30, 6, 643, DateTimeKind.Utc).AddTicks(837)
                        });
                });
