...
namespace TerminalApi.Migrations
{
    ...
    [Migration("20250419094954_isbanned_field_user")]
    partial class isbanned_field_user
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TerminalApi.Models.TVA.TVARate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("097ddc18-1016-4c05-a823-867a41c99574"),
                            Rate = 0.2m,
                            StartAt = new DateTime(2025, 4, 19, 9, 49, 53, 776, DateTimeKind.Utc).AddTicks(7880)
                        });
                });
