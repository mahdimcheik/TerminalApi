...
namespace TerminalApi.Controllers
{
    ...
    public class BillController : ControllerBase
    {
        ...
        /// <summary>
        /// Télécharge un fichier vers le serveur Minio.
        /// </summary>
        /// <param name="file">Fichier à télécharger.</param>
        /// <param name="minioFolderName">Nom du dossier dans Minio.</param>
        /// <param name="entityId">Identifiant de l'entité associée.</param>
        /// <returns>Informations sur le fichier téléchargé avec son URL d'accès.</returns>
        /// <response code="200">Fichier téléchargé avec succès.</response>
        /// <response code="400">Erreur lors du téléchargement du fichier.</response>
        [HttpPost("file")]
            ...
            var metadata = new Dictionary<string, string>
        {
            ...
            {
                // Gestion du cas où le fichier est déjà supprimé ou en cours d'utilisation
