...
namespace TerminalApi.Interfaces
{
    ...
    {
        Task<NotificationResponseDTO> AddNotification(
            Notification notification,
            string? customDescription = null
        );
        Task<Notification> ToggleNotification(Guid notificationId);
        Task DeleteNotification(Guid notificationId);
        Task<PaginatedNotificationResult<NotificationResponseDTO>> GetNotifications(
            string userId,
        ...
        Task<PaginatedNotificationResult<NotificationResponseDTO>> GetUserNotificationsAsync(
            string userId,
            NotificationFilter filter
        );
    }
